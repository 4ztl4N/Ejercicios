...
# Crear carroscar1 = Car("spark gt", "20.000.000")car2 = Car("aveo", "18.000.000")car3 = Car("toyota hilux", "80.000.000")car4 = Car("hyundai", "17.000.000")
# Crear personasperson1 = Person("Laura", "0001")person2 = Person("Andres", "0002")person3 = Person("Sore", "0003")
# Crear dealerdealer = Dealer()dealer.add\_car(car1)dealer.add\_car(car2)dealer.add\_car(car3)dealer.add\_car(car4)
# Mostrar carros disponiblesdealer.available\_cars()
# Comprar un carroperson1.buy\_car(car1)
# Mostrar carros disponibles después de la compradealer.available\_cars()
# Vender un carro de una persona al dealerperson1.sell\_car(car1, dealer)
# Mostrar carros disponibles después de añadir un carro al dealerdealer.available\_cars()